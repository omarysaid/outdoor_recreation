...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    if ($_FILES["new_image"]["name"]) {
        ...
        // here if Updating data without changing the image
        ...
        if ($stmt->execute()) {
            $_SESSION['success_message'] = "Record updated successfully.";
            header("Location: update_recreation.php?recreation_id=$recreation_id");
            exit();
        } else {
            echo "Error updating record: " . $stmt->error;
        }
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="time" value="<?php echo htmlspecialchars($time); ?>"
