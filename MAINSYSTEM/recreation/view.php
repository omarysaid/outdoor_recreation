...
<div class="content-wrapper">
    <div class="card-header">
        <a href="./add.php"><button class="btn btn-success" style="margin-left: 10px;">New Recreation</button></a>
    </div>
    ...
    ?>
                                    ...
                                    <td>
                                        <span>
                                            <a href="./update.php?recreation_id=<?php echo $row['recreation_id'] ?>">
...
function confirmDelete(Id) {
    if (confirm("Are you sure you want to delete?")) {
        window.location.href = "./delete.php?recreation_id=" + Id;
    }
}
</script>
